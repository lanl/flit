...
contains
    ...
    subroutine gst_localdip3(w, dp1, dp2, k1, k2, k3)
        ...
        ! smooth structure tensor with a sigma=1 Gaussian filter
        !        call gauss_filt(s11, [1.0, 1.0, 1.0])
        !        call gauss_filt(s12, [1.0, 1.0, 1.0])
        !        call gauss_filt(s13, [1.0, 1.0, 1.0])
        !        call gauss_filt(s22, [1.0, 1.0, 1.0])
        !        call gauss_filt(s23, [1.0, 1.0, 1.0])
        !        call gauss_filt(s33, [1.0, 1.0, 1.0])
